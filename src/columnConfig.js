...
export const BOARD_COLUMNS = [
  ...
  { key: '최근만남결과', label: '최근만남결과', type: 'select', width: 100, badgeType: 'meeting' },
...
export const DB_COLUMNS = [
  { key: '구분', label: '단계', type: 'select', width: 72, readonly: true, badgeType: 'stage' },
  { key: '실적지역', label: '지역', type: 'select', width: 72, badgeType: 'region' },
  { key: '목표개강(연도/월)', label: '목표개강', type: 'text', width: 90, readonly: true },
  { key: '목표센터', label: '목표센터', type: 'select', width: 90 },
  { key: '섭외유형', label: '섭외유형', type: 'select', width: 80 },
  { key: '섭외자', label: '섭외자', type: 'text', width: 80, readonly: true },
  { key: '인도자', label: '인도자', type: 'text', width: 80, readonly: true },
  { key: 'TM현재상태', label: 'TM현재상태', type: 'select', width: 130, badgeType: 'tm_status' },
  { key: 'TM현황', label: 'TM현황', type: 'textarea', width: 180 },
  { key: '컨설팅유무', label: '컨설팅유무', type: 'select', width: 96 },
  { key: '성별', label: '성별', type: 'select', width: 56, badgeType: 'gender' },
  { key: '나이', label: '나이', type: 'number', width: 56 },
...
// Region colors (matching DB-system)
